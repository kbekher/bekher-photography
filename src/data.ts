...
export const galleriesData = {
  ...
  pentax17: {
    ...
    photos: [
      ...
      { aspectRatio: vertical, path: "ladies-walking-amsterdam-pentax17.jpg", styles: "p-14 pb-0 xl:p-0 xl:py-6 xl:pl-80 xl:pr-2" },
      { aspectRatio: vertical, path: "tourists-in-amsterdam-pentax17.jpg", styles: "p-14 pt-0 xl:p-0 xl:py-6 xl:pt-18 xl:pl-2 xl:pr-80" },
