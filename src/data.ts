...
export const galleriesData = {
  ...
  alpineescape: {
    ...
    photos: [
      ...
      { aspectRatio: vertical, path: "mount-reflection-in-lake-alps.jpg", styles: "px-0 xl:p-0 xl:py-6 xl:pr-2", },
  ...
  pentax17: {
    ...
    photos: [
      ...
      { aspectRatio: vertical, path: "man-with-pipe-big-shot-coffee-paris-pentax17.jpg", styles: "px-0 pb-14 xl:p-0 xl:pl-4 xl:py-18" },
      ...
      { aspectRatio: vertical, path: "bike-corner-canals-amsterdam-pentax17.jpg", styles: "px-0 xl:p-0 xl:py-6 xl:pl-14", },
      { aspectRatio: vertical, path: "ladies-walking-amsterdam-pentax17.jpg", styles: "p-14 pb-0 xl:p-0 xl:py-10 xl:pt-16 xl:pl-80 xl:pr-2", },
      { aspectRatio: vertical, path: "tourists-in-amsterdam-pentax17.jpg", styles: "p-14 pt-0 xl:p-0 xl:py-10 xl:pb-16 xl:pl-2 xl:pr-80", },
      { aspectRatio: vertical, path: "city-ducks-dusseldorf-pentax17.jpg", styles: "p-5 xl:p-0 xl:py-6 ", },
    ] as PhotoMetadata[],
  },
  momentsofstillness: {
    ...
    photos: [
      ...
      { aspectRatio: horizontal, path: "cat-on-the-beach-malaga.jpg", styles: "px-0 pb-5 xl:p-0 xl:py-40 xl:px-60",},
      ...
      { aspectRatio: vertical, path: "fall-leaves-and-sky.jpg", styles: "px-0 pt-12 xl:p-0 xl:py-6 xl:pl-3", },
  ...
  europeanfeel: {
    ...
    photos: [
      ...
      { aspectRatio: vertical, path: "view-from-bridge-brugges.jpg", styles: "px-0 pb-10 xl:p-0 xl:py-18 xl:pl-6", },
      ...
      { aspectRatio: horizontal, path: "hanging-clothes-venice.jpg", styles: "px-0 pb-10 xl:p-0 xl:pl-120 xl:pt-18 xl:pb-50 xl:pr-4", },
  ...
  grainofukraine: {
    ...
    buffer: 78,
    photos: [
      { aspectRatio: vertical, path: "vdnh-kyiv-tower.jpg", styles: "px-5 xl:p-0 xl:pr-120", },
      { aspectRatio: horizontal, path: "kyiv-velotrek-mural.jpg", styles: "py-12 xl:p-0 xl:pt-48 xl:pb-20 xl:px-4",},
      { aspectRatio: horizontal, path: "kyiv-ghost-mural-podil.jpg", styles: "px-12 pb-12 xl:p-0 xl:pb-48 xl:pt-20 xl:px-4",},
      { aspectRatio: horizontal, path: "ukraine-landscape-kyiv-region.jpg", styles: "p-0 xl:p-0 xl:pl-120 xl:pr-30 xl:py-6",},
      { aspectRatio: horizontal, path: "ruined-brigde-war-kyiv-region.jpg", styles: "p-0 xl:p-0 xl:px-30 xl:py-18",},
      { aspectRatio: horizontal, path: "kyiv-storm-clouds.jpg", styles: "px-10 pt-12 xl:p-0 xl:pl-30 xl:pr-12 xl:py-46",},
      { aspectRatio: horizontal, path: "kyiv-in-storm-winter.jpg", styles: "px-10 xl:p-0 xl:px-12 xl:py-18",},
    ] as PhotoMetadata[],
  },
  jazzyblues: {
    id: 'jazzyblues',
    ...
    photos: [
      ...
      { aspectRatio: vertical, path: "design-books-jazzy-blues.jpg", styles: "p-0 xl:p-0 xl:py-6", },
      ...
      { aspectRatio: horizontal, path: "mother-and-daughter-revolog.jpg", styles: "p-0 pb-8 xl:p-0 xl:py-6 xl:px-3", },
  ...
  facesandplaces: {
    ...
    buffer: 80,
    photos: [
      { aspectRatio: vertical, path: "olives-festa-italiana-unna.jpg", styles: "px-5 pb-12 xl:p-0 xl:pr-60" },
      { aspectRatio: horizontal, path: "girl-with-dogs-prohorivka.jpg", styles: "px-8 xl:p-36 xl:pr-18" },
      { aspectRatio: horizontal, path: "guys-on-the-beach-italy.jpg", styles: "px-8 pb-12 xl:p-18 xl:pr-60" },
      { aspectRatio: vertical, path: "girl-in-glasses-park-guel.jpg", styles: "pb-20 xl:p-0 xl:pr-120 xl:pl-60 xl:py-6" },
