...
export const galleriesData = {
  noiretblanc: {
    ...
    photos: [
      { aspectRatio: vertical, path: "road-in-mist-bw.jpg", styles: "px-5 xl:p-0",},
      { aspectRatio: horizontal, path: "mohnesee-in-winter-bw.jpg", styles: "px-5 xl:p-0",},
      { aspectRatio: horizontal, path: "retro-car-bw.jpg", styles: "px-5 xl:p-0",},
      { aspectRatio: horizontal, path: "artist-portrait-pencil-bw.jpg", styles: "px-5 xl:p-0",},
      { aspectRatio: horizontal, path: "old-tea-set-bw.jpg", styles: "px-5 xl:p-0",},
      { aspectRatio: horizontal, path: "window-rain-plant-bw.jpg", styles: "px-5 xl:p-0",},
    ] as PhotoMetadata[],
  },
  alpineescape: {
    id: 'alpineescape',
    ...
    buffer: 78,
    photos: [
      { aspectRatio: vertical, path: "duck-on-fallen-tree-thun-lake.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: horizontal, path: "alpine-cow.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "cows-in-alps-murren.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: horizontal, path: "wooden-houses-in-alps.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "mount-reflection-in-lake-alps.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "mountain-lake-schilthorn.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: horizontal, path: "house-in-mountains-with-dog-murren.jpg", styles: "px-5 xl:p-0", },
    ] as PhotoMetadata[],
  },
  jazzyblues: {
    id: 'jazzyblues',
  ...
  momentsofstillness: {
    ...
    buffer: 76,
    photos: [
      { aspectRatio: vertical, path: "braun-leaves-lake-water-backdrop.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: horizontal, path: "cat-on-the-beach-malaga.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: horizontal, path: "spring-mognolia-blooming.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "spring-blooming-trees.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "small-river-in-the-forest.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "fall-leaves-and-sky.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: horizontal, path: "sheep-mother-and-baby-cinestill.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "flowers-in-jars-munster.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: horizontal, path: "boats-in-port-barcelona.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: horizontal, path: "boat-water-lake-geneva.jpg", styles: "px-5 xl:p-0", },
    ] as PhotoMetadata[],
  },
  europeanfeel: {
    id: 'europeanfeel',
  ...
  facesandplaces: {
    ...
    photos: [
      ...
      { aspectRatio: vertical, path: "girl-in-glasses-park-guel.jpg", styles: "pb-20 xl:p-0 xl:flex xl:justify-end" },
  ...
  pentax17: {
    ...
    buffer: 76,
    photos: [
      { aspectRatio: vertical, path: "night-eiffel-tower-paris-pentax17.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "man-with-pipe-big-shot-coffee-paris-pentax17.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "golden-hour-canal-venice-pentax17.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "night-canal-boat-venice-pentax17.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "cyclist-christmas-amsterdam-pentax17.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "bike-corner-canals-amsterdam-pentax17.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "ladies-walking-amsterdam-pentax17.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "tourists-in-amsterdam-pentax17.jpg", styles: "px-5 xl:p-0", },
      { aspectRatio: vertical, path: "city-ducks-dusseldorf-pentax17.jpg", styles: "px-5 xl:p-0", },
    ] as PhotoMetadata[],
  },
};
